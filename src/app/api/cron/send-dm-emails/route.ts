...
//
// Déclenché par Vercel Cron (cf. vercel.json) toutes les 2 minutes. La route
// vérifie l'authentification via :
...
//
// Idempotent : si on rappelle deux fois en moins de 2 minutes, le second
