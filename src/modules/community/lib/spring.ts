...
//
// Copie autonome (règle d'isolation modules : community ne peut pas importer
// depuis ressources) de la courbe validée au lab morph. Réponse indicielle d'un
// ressort critiquement amorti : décélération douce et MONOTONE, ZÉRO overshoot →
// l'élément ne « rebondit » jamais et se cale net sur sa cible.
