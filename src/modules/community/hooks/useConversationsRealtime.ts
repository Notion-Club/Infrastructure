...
//
// Historique : la mig. 047 a d'abord conservé EN PARALLÈLE l'ancien abonnement
// table-wide postgres_changes (mig. 039) comme filet de sécurité, le temps de
// valider le broadcast en prod. Broadcast confirmé → filet retiré (mig. 048 :
// messages sorti de la publication supabase_realtime). Le DM ne repose plus que
// sur le broadcast par conversation.
